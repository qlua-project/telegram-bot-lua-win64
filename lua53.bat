...
rem "%CWD%/externals/lua-5.3.5\bin\lua.exe" -e "package.path=\"%CWD_LUA%\\lua_modules\\share\\lua\\5.3\\?.lua;%CWD_LUA%\\lua_modules\\share\\lua\\5.3\\?\\init.lua;%APPDATA_LUA%\\luarocks\\share\\lua\\5.3\\?.lua;%APPDATA_LUA%\\luarocks\\share\\lua\\5.3\\?\\init.lua;\"..package.path;package.cpath=\"%CWD_LUA%\\lua_modules\\lib\\lua\\5.3\\?.dll;%APPDATA_LUA%\\luarocks\\lib\\lua\\5.3\\?.dll;\"..package.cpath" %I% %*
"%CWD%/externals/lua-5.3.5\bin\lua.exe" -e "package.path=\"%CWD_LUA%\\lua_modules\\share\\lua\\5.3\\?.lua;%CWD_LUA%\\lua_modules\\share\\lua\\5.3\\?\\init.lua;\"..package.path;package.cpath=\"%CWD_LUA%\\lua_modules\\lib\\lua\\5.3\\?.dll;\"..package.cpath" %I% %*
exit /b %ERRORLEVEL%
